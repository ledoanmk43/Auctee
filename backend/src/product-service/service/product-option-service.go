...
type ProductOptionService interface {
	CreateOption(proOption *entity.ProductOption) (*entity.ProductOption, error)
...
func (p *productOptionService) CreateOption(proOption *entity.ProductOption) (*entity.ProductOption, error) {
	var proDTO dto.ProductDTO
	proDTO.ProductId = proOption.ProductId
	...
	createdOption, err := p.ProductOptionRepository.CreateOption(proOption)
	if err != nil {
