...
// Source: ./src/admin-service/service/account-service.go

// Package service is a generated GoMock package.
package service

import (
	"backend/pkg/pb/admin"
	dto "backend/src/account-service/dto"
	entity "backend/src/account-service/entity"
	reflect "reflect"
...
func (m *MockIAdminService) CreateAdmin(admin *entity.Account) (*entity.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockIAdminService) VerifyCredential(loginDTO *dto.AdminLoginDTO) (*entity.Account, error) {
	m.ctrl.T.Helper()
